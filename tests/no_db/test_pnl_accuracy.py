...
def test_pnl_session_carryover():
    ...
    pm = PositionManager(
        symbol="NIFTY", quantity=10, sl_points=20, target_points=[50], instrument_type=InstrumentType.OPTIONS
    )
...
def test_intra_candle_sl_hit():
    ...
    """
    pm = PositionManager(
        symbol="NIFTY", quantity=1, sl_points=15, target_points=[], instrument_type=InstrumentType.OPTIONS
    )
