...
def mock_db():
    ...
    db.__getitem__.side_effect = lambda key: {
        settings.INSTRUMENT_MASTER_COLLECTION: mock_master_col
    }.get(key, MagicMock())
    return db
...
def test_contract_discovery_cache_logic(mock_db):
    ...
    mock_master_col = mock_db[settings.INSTRUMENT_MASTER_COLLECTION]
    mock_instruments = [
        {"exchangeInstrumentID": 101, "strikePrice": 25000, "optionType": 3, "contractExpiration": "2026-03-20T14:30:00", "description": "NIFTY 25000 CE"},
        {"exchangeInstrumentID": 102, "strikePrice": 25000, "optionType": 4, "contractExpiration": "2026-03-20T14:30:00", "description": "NIFTY 25000 PE"},
    ]
...
def test_backtest_relative_discovery(mock_db):
    ...
    mock_instruments = [
        {"exchangeInstrumentID": 999, "strikePrice": 22000, "optionType": 3, "contractExpiration": past_expiry, "description": "NIFTY 22000 CE (OLD)"},
    ]
    mock_master_col.find.return_value = mock_instruments
