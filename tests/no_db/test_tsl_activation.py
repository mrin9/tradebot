...
class TestTSLActivation(unittest.TestCase):
    def test_tsl_moves_before_t1(self):
        ...
        pm = PositionManager(
            symbol="NIFTY", quantity=50, sl_points=10.0, target_points=[10.0, 20.0], tsl_points=5.0, use_be=True
        )
    ...
    def test_tsl_id_moves_before_t1(self):
        ...
        pm = PositionManager(
            symbol="NIFTY", quantity=50, sl_points=10.0, target_points=[10.0, 20.0], tsl_id="active-ema-5", use_be=True
        )
