...
def get_parser():
    ...
    parser.add_argument("--end", type=str, default="2026-02-02", help="End Date (YYYY-MM-DD)")
    ...
    parser.add_argument("--target-steps", type=str, default="15,25,50", help="Comma separated target points")
    ...
    parser.add_argument("--invest-mode", type=str, choices=["compound", "fixed"], default="compound")
    ...
    parser.add_argument("--strategy-mode", type=str, choices=["rule", "ml"], default="rule", help="Strategy engine: rule (JSON-DSL) or ml (ML model)")
    ...
    parser.add_argument("--warmup-candles", type=int, default=200, help="Number of candles to use for indicator warmup")
    return parser
