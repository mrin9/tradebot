...
class MasterDataCollector:
    ...
    def _filter_instruments(self, raw_data):
        ...
        for doc in raw_data:
            ...
            if series not in allowed_series and inst_id != settings.NIFTY_EXCHANGE_INSTRUMENT_ID:
                continue
    ...
    def _update_mongo(self, data):
        ...
        delete_res = coll.delete_many(
            {"series": {"$nin": allowed_series}, "exchangeInstrumentID": {"$ne": settings.NIFTY_EXCHANGE_INSTRUMENT_ID}}
        )
