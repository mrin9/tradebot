...
class MDSocket_io:
    ...
    def _internal_on_connect(self):
        ...
        if callable(self.on_connect): self.on_connect()

    def _internal_on_message(self, data):
        if callable(self.on_message): self.on_message(data)
    ...
    def _internal_on_disconnect(self):
        ...
        if callable(self.on_disconnect): self.on_disconnect()

    def _internal_on_error(self, data):
        logger.error(f'Market Data Error: {data}')
        if callable(self.on_error): self.on_error(data)
