...
class DriftManager:
    ...
    def __init__(
        ...
        self.selection_spot_price: Optional[float] = None
        ...
        self.on_instruments_changed: Optional[Callable[[Dict[str, int]], None]] = None
        ...
        if needs_update:
            ...
            for cat, is_ce in [("CE", True), ("PE", False)]:
                ...
                if new_id:
                    ...
                    logger.warning(f"⚠️ DriftManager: Failed to resolve {cat} contract for strike {atm_strike} at {current_ts}")
            ...
            if self.on_instruments_changed:
                ...
                changed_info = {
                    ...
                    "instruments": {
                        ...
                        for cat in ["CE", "PE"] if self.active_instruments.get(cat)
                    }
                }
    ...
    def get_instrument_id(self, category: str) -> Optional[int]:
